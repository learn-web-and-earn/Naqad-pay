    ...
    <div className="min-h-[90vh] bg-white flex flex-col justify-between px-6 pt-10 pb-6">
      ...
      <div className="w-full flex flex-col mt-10 flex-1">
        ...
        <div className="w-full mt-8">
          ...
          <div className="flex items-center border rounded-lg px-3 h-14">
            <img src={Flag} alt="UAE" className="w-6 h-6" />
            <span className="ml-2 mr-2">+971</span>
            <div className="w-[1px] h-5 bg-gray-300 mx-2" /> {/* Divider */}
            <Input
              value={phone}
              onChange={(e) => setPhone(e.target.value)}
              className="border-0 shadow-none focus:outline-none focus:ring-0 flex-1 p-0 h-full"
            />
          </div>
        </div>
        ...
        <div className="w-full mt-6">
          ...
          <div className="relative flex items-center border rounded-lg px-3 h-14">
            ...
            <Input
              ...
              className="flex-1 border-0 focus:outline-none focus:ring-0 h-full"
            />
            <button
              type="button"
          ...
          <p className="text-right font-semibold text-sm text-blue-900 mt-2 cursor-pointer">
            Forgot Password?
          </p>
        </div>
      </div>
